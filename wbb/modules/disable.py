...
if is_module_loaded(FILENAME):
    ...
    from Soulmatebot.modules.helper_funcs.chat_status import (
        connection_status,
        is_user_admin,
        user_admin,
    )
    from Soulmatebot.modules.sql import disable_sql as sql
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            enable_module = "wbb.modules." + args[0].rsplit(".", 1)[0]
